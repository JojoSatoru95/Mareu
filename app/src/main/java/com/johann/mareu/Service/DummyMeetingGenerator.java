...
public abstract class DummyMeetingGenerator {
    ...
    public static List<Meeting> DUMMY_MEETINGS = Arrays.asList(new Meeting("Peach", "Marketing", "alexandre@gmail.com, jeanluc@gmail.com, pierre@gmail.com", new Date(1640007000000L), new Date(1640007000000L)),
            ...
            new Meeting("Toad", "Projet","benjamin@gmail.com, fanny@gmail.com, eric@gmail.com", new Date(1640077200000L), new Date(1640077200000L)),
            new Meeting("Wario", "Bilan du mois", "alexandra@gmail.com, ludovic@gmail.com", new Date(1640169000000L), new Date(1640169000000L)));
